...
// Adjust the sliding speed of the blue square (player)
// Decreased speed for a more coherent slide
...
function mainLoop(time) {
  const deltaTime = (time - lastTime) / 1000 // 1000 time elpsed;
  lastTime = time;
  ...
  if (!gameOver) {
    ...
    const points = Math.floor(speed*3);
